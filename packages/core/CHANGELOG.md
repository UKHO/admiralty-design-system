...
- feat: updated tooltip css ([@developernm](https://github.com/developernm))
- feat: updated website ([@developernm](https://github.com/developernm))
- feat: update rich tooltip and fixed bugs ([@developernm](https://github.com/developernm))
- feat: logic to handle off screen ([@developernm](https://github.com/developernm))
- feat: update tooltip logic ([@developernm](https://github.com/developernm))
- feat: tooltip modified ([@developernm](https://github.com/developernm))
- feat: tooltip changes ([@developernm](https://github.com/developernm))
- feat: tooltip logic ([@developernm](https://github.com/developernm))
- feat: tool tips ([@developernm](https://github.com/developernm))

#### 🐛 Bug Fix

- Merge branch 'next' into feat-tooltips ([@lstevens98](https://github.com/lstevens98))
- style: update tooltip styles to use variables for colors and improve formatting (mohamme15315@mastek.com)
- Running a build to ensure up to date autogenerated files are checked in ([@ecstaticrainbow](https://github.com/ecstaticrainbow))
- Merge branch 'main' into feat-tooltips ([@lstevens98](https://github.com/lstevens98))
- Fix comments ([@lstevens98](https://github.com/lstevens98))
- Merge branch 'main' into dynamic-autocomplete-icon ([@lstevens98](https://github.com/lstevens98))
- Merge branch 'main' into feat-tooltips (mohamme15315@mastek.com)
- add latest autogenerated files ([@lstevens98](https://github.com/lstevens98))
- Update component to allow for custom icon ([@lstevens98](https://github.com/lstevens98))
- Update tooltip readme formatting and adjust CSS for dark mode theme toggle (mohamme15315@mastek.com)
- Refactor tooltip component: update structure, improve accessibility, and enhance positioning logic (mohamme15315@mastek.com)
- Add end-to-end and unit tests for tooltip component functionality (mohamme15315@mastek.com)
- Merge branch 'feat-tooltips' of https://github.com/UKHO/admiralty-design-system into feat-tooltips (mohamme15315@mastek.com)
- Refactor tooltip component for improved event handling and code consistency (mohamme15315@mastek.com)
- Merge branch 'next' into feat-tooltips ([@ecstaticrainbow](https://github.com/ecstaticrainbow))
