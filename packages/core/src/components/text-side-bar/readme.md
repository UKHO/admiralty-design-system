...
| `textSideBarWidth` | `text-side-bar-width` | Sets the sidebar width                                                              | `string`  | `'150px'`              |
...
| Slot       | Description                                                                                                                          |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `"footer"` | additional 'admiralty-text-side-bar-item' components can be placed in the footer slot to display at the bottom of the text side bar. |
