...
| `checkboxBlur`    | Event is fired when the form control loses focus   | `CustomEvent<FocusEvent<Element, Element>>`   |
| `checkboxFocus`   | Event is fired when the form control gains focus   | `CustomEvent<FocusEvent<Element, Element>>`   |
