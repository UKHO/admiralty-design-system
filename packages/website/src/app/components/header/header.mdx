...
Use the header to signal to users they are in the right place. Contains primary site navigation, title and key logos. [View this component on GitHub](https://github.com/UKHO/admiralty-design-system/tree/main/packages/core/src/components/header)
