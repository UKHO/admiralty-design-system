...
## Colour
Pills can be displayed in different colours when necessary, but use colour thoughtfully to maintain clarity and consistency. Excessive use of colour can overwhelm users and reduce readability.

Best practise when using colour:
...
<b>Methods</b>: Describe any public methods available for interacting with the component programmatically.
