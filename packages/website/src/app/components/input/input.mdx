# Input
Use a text input to allow users to input text in various ways. [View this component on GitHub](https://github.com/UKHO/admiralty-design-system/tree/main/packages/core/src/components/input)
...
## Skeleton Loading
The input displays a skeleton loading effect, when loading is set to `true`

import Loading from "@/usage/input/loading/index.mdx";
