...
import TypographicScaleVariables from "./typographic-scale-variables";
import SpacingVariables from "./spacing-variables";
import TypographicScaleWeights from "./typographic-scale-weights";
...
<TypographicScaleVariables/>

<br/>

### Font weights

<TypographicScaleWeights/>
...
The following values are based on the assumption that your browser default is set to 16px.
