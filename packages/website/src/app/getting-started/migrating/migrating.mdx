...
This guide provides information about how to update to v5 of the Admiralty Design System.

## Fonts

There is no longer the need to add the fonts as a dependency to your application or website, as we now load them from a central CDN, making them faster and easier to update.

Going the forward the font being used is called 'Johnston ITC Pro' not ~~'Johnston ITC'~~.

> **⚠️ <b>Deprecated:</b> **
> ### This entire font-face block is no longer used or required.
