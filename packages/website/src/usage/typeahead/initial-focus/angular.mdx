```html
<admiralty-type-ahead resultsOnInitFocus="true" label="Favourite Animal?" hint="Please type your favourite animal from the list below" placeholder="Please type here">
