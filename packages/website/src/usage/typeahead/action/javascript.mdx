```html
<script>
      document.querySelector('admiralty-type-ahead').addEventListener('selectionChanged', () => console.log('selectionChanged'));
</script>
<admiralty-type-ahead label="Favourite Animal?" hint="Please type your favourite animal from the list below" placeholder="Please type here">
