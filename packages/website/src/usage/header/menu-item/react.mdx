```tsx
<AdmiraltyHeader logo-alt-text="ADMIRALTY" logo-link-url="http://www.example.com" logo-img-url="svg/Admiralty stacked logo.svg" header-title-url="#" header-title="Design System">
