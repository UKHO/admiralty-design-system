...
@ProxyCmp({
  inputs: ['assistiveHint', 'autoSelect', 'confirmOnBlur', 'disabled', 'hint', 'invalid', 'invalidMessage', 'label', 'minLength', 'name', 'placeholder', 'showAllValues', 'showNoOptionsFound', 'value']
})
@Component({
